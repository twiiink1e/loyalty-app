                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="datePickerId" name="expire">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('topic') }}"
                                            id="example-text-input" placeholder="Enter announcement topic" name="topic"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" value="" id="example-tel-input"
                                            name="thumbnail">
                                    </div>
