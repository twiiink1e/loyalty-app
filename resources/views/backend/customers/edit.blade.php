                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ $customer->name }}" id="example-text-input"
                                            placeholder="Enter customer name" name="name">
                                    </div>

                                    <div class="mb-3">
                                        <label for="example-tel-input" class="form-label">Phone Number</label>
                                        <input class="form-control" type="text" value="{{ $customer->phone }}" id="example-tel-input"
                                            placeholder="Enter customer phone number" name="phone">
                                    </div>

                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">Address</label>
                                        <input class="form-control" type="text-area" value="{{ $customer->address }}" id="example-text-input"
