    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Reward Information</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                        <li class="breadcrumb-item active">Reward Information</li>
                    </ol>
                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('name') }}" id="example-text-input"
                                            placeholder="Enter reward" name="name">
                                    </div>

                                    <div class="mb-3">
                                        <label for="example-tel-input" class="form-label">Point</label>
                                        <input class="form-control" type="text" value="{{ old('point') }}" id="example-tel-input"
                                            placeholder="Enter point" name="point">
                                    </div>

                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">Remark</label>
                                        <input class="form-control" type="text-area" value="{{ old('remark') }}" id="example-text-input"
                                            placeholder="Enter remark" name="remark">
                                    </div>
